  ...
  return <div className="flex flex-col h-full">
      <div className="flex items-center justify-between bg-secondary/50 px-4 py-2 rounded-t-lg border border-border">
        <div className="flex items-center gap-2">
          ...
          {autoSaved && <span className="text-xs text-muted-foreground flex items-center gap-1 animate-in fade-in">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-0 border-x border-border">
        <div className="flex-1 relative">
          ...
          <textarea ref={textareaRef} value={code} onChange={e => setCode(e.target.value)} onKeyDown={handleKeyDown} className="w-full h-full min-h-[300px] pl-14 pr-4 py-4 bg-code font-mono text-sm text-foreground resize-none focus:outline-none leading-6" spellCheck={false} readOnly={readOnly} placeholder="Write your code here..." />
        </div>
