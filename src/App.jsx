        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/teacher/assessments" element={<ProtectedRoute allowedRoles={['teacher']}>
                  <AppLayout><TeacherAssessments /></AppLayout>
                </ProtectedRoute>} />
              <Route path="/teacher/create" element={<ProtectedRoute allowedRoles={['teacher']}>
                  <AppLayout><CreateAssessment /></AppLayout>
                </ProtectedRoute>} />
              <Route path="/teacher/workspace" element={<ProtectedRoute allowedRoles={['teacher']}>
                  <AppLayout><TeacherWorkspace /></AppLayout>
                </ProtectedRoute>} />
              <Route path="/teacher/students" element={<ProtectedRoute allowedRoles={['teacher']}>
              ...
              <Route path="/student/assessments" element={<ProtectedRoute allowedRoles={['student']}>
                  <AppLayout><StudentAssessments /></AppLayout>
                </ProtectedRoute>} />
              <Route path="/student/assessments/:id" element={<ProtectedRoute allowedRoles={['student']}>
                  <SolveAssessment />
                </ProtectedRoute>} />
              ...
              {/* Professional routes */}
              <Route path="/professional/dashboard" element={<ProtectedRoute allowedRoles={['professional']}>
                  <AppLayout><ProfessionalDashboard /></AppLayout>
                </ProtectedRoute>} />
              <Route path="/professional/practice" element={<ProtectedRoute allowedRoles={['professional']}>
                  <AppLayout><ProfessionalPractice /></AppLayout>
                </ProtectedRoute>} />
              <Route path="/professional/challenges" element={<ProtectedRoute allowedRoles={['professional']}>
                  <AppLayout><ProfessionalChallenges /></AppLayout>
                </ProtectedRoute>} />
              <Route path="/professional/challenges/:id" element={<ProtectedRoute allowedRoles={['professional']}>
                  <SolveChallenge />
                </ProtectedRoute>} />
