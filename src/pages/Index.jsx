      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={() => navigate('/login')} className="btn-primary py-3 px-8 text-lg flex items-center justify-center gap-2">
              Start Learning
              <ArrowRight className="w-5 h-5" />
            </button>
            <button onClick={() => navigate('/login')} className="btn-outline py-3 px-8 text-lg">
              I'm a Teacher
            </button>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-secondary/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => <div key={index} className="card-elevated hover:shadow-lg transition-shadow">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[{
            title: 'Student',
            desc: 'Solve assessments, track progress, and improve your coding skills',
            icon: <BookOpen className="w-8 h-8 text-easy" />,
            bg: 'bg-success-light'
          }, {
            title: 'Teacher',
            desc: 'Create assessments, monitor students, and manage your workspace',
            icon: <Users className="w-8 h-8 text-primary" />,
            bg: 'bg-info-light'
          }, {
            title: 'Professional',
            desc: 'Sharpen your skills with challenging problems and track your growth',
            icon: <Zap className="w-8 h-8 text-warning" />,
            bg: 'bg-warning-light'
          }].map(card => <div key={card.title} className="card-elevated text-center hover:border-primary transition-colors cursor-pointer" onClick={() => navigate('/login')}>
