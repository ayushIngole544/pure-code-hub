...
export default function StudentDashboard() {
  ...
  return <div className="page-container">
      ...
      <div>
        ...
        {availableAssessments.length > 0 ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {availableAssessments.map(assessment => <AssessmentCard key={assessment.id} assessment={assessment} onClick={() => navigate(`/student/assessments/${assessment.id}`)} />)}
