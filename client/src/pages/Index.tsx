      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            CodeHub is the all-in-one platform for students, teachers, and professionals
            to learn, teach, and practice coding skills.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                title: 'Student',
                desc: 'Solve assessments and improve your coding skills',
                icon: <BookOpen className="w-8 h-8 text-easy" />,
                bg: 'bg-success-light'
              },
              {
                title: 'Teacher',
                desc: 'Create assessments and manage students',
                icon: <Users className="w-8 h-8 text-primary" />,
                bg: 'bg-info-light'
              },
              {
                title: 'Professional',
                desc: 'Sharpen your skills with advanced challenges',
              ...
              <div
                key={card.title}
                className="card-elevated text-center hover:border-primary transition-colors cursor-pointer"
                onClick={() => navigate('/login')}
              >
